...
The landing page provides a simple entry point for starting an AI-powered interview practice session.

![AI Interview Coach Landing Page](assets/screenshots/landing-page.png)

### Interview Recording Interface

Once the session begins, the application presents an interview question and allows the user to record their spoken response directly from the browser. The interface also checks microphone access before recording.

![AI Interview Coach Recording Interface](assets/screenshots/interview-session.png)
